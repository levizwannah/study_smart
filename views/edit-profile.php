...
<form class="p-6 pb-4 space-y-6 text-gray-600" method="POST">
    ...
    <div class="flex flex-col mb-4">
        <button type="button" id="" class="rounded-md text-white bg-green-500 w-full py-2 px-4 text-sm font-bold">Edit Profile</button>
        <span class="mb-3">Do you want to reset your password? <a href="password-reset.php" class="text-green-500 text-gray-500 hover:underline">Change Password</a></span>
    </div>
</form>
</body>
</html>
