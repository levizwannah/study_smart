...
<div class="p-6 pb-4 space-y-6 text-gray-600">
    ...
    <div class="flex flex-col">
        ...
        <input class="text-sm text-gray-500 py-2 px-4 rounded-3xl border focus:outline-none" type="date" name="dateGiven" id="dateGiven">
    </div>
    <!--Date Due-->
    <div class="flex flex-col">
        <label class="font-medium" for="dateDue">Date Due</label>
        <input class="text-sm text-gray-500 py-2 px-4 rounded-3xl border focus:outline-none" type="date" name="dateDue" id="dateDue">
    </div>
    <!--Button-->
    <div class="select-none rounded-md flex flex-1 items-center p-4 transition duration-500 ease-in-out transform hover:-translate-y-2 rounded-2xl p-6 mt-3 border-gray-300 hover:shadow-2xl">
                <div class="ml-24 w-1/4 text-wrap items-center flex flex-col text-white text-xs font-bold rounded-md bg-green-500 justify-center items-center mr-10 p-2">
                    <p>Add</p>
                </div>
            </div>
</div>
